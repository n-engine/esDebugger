...
It contain also a simple dialog management for the calls history report.

test.cxx contain two simple example, breakOn(Error/Warning) and a loop to see the calls history.
